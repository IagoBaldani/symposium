          ...
          <div class="table-wrapper-scroll-y my-custom-scrollbar">
            <table class="table-bordered">
              ...
              <tr>
                ...
                <td class="td-visualizar text-center"><a><img class="click-button" src="../../assets/imgs/visibility_white_24dp.svg"></a></td>
                <td class="td-download text-center"><a><img class="click-button" src="../../assets/imgs/settings_white_24dp.svg"></a></td>
              </tr>
              </tbody>
            </table>
          </div>
